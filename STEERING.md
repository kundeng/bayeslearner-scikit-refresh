...
- **Python fluency.** The reader writes Python comfortably and uses NumPy for array computation. Prior experience with scipy or statsmodels is *not* assumed --- Chapter 1 teaches these from the ground up.
